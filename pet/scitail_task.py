...
class SciTailProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir: str) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, SciTailProcessor.TRAIN_FILE_NAME), "train")
    ...
    def get_dev_examples(self, data_dir: str) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, SciTailProcessor.DEV_FILE_NAME), "dev")
    ...
    def get_test_examples(self, data_dir) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, SciTailProcessor.TEST_FILE_NAME), "test")
    ...
    def get_unlabeled_examples(self, data_dir) -> List[InputExample]:
        ...
        """
        return self._create_examples(os.path.join(data_dir, SciTailProcessor.UNLABELED_FILE_NAME), "unlabeled")

    def get_labels(self) -> List[str]:
        """This method returns all possible labels for the task."""
        return SciTailProcessor.LABELS
    ...
    def _create_examples(self, path, set_type, max_examples=-1, skip_first=0):
        ...
        with open(path, "r", encoding="utf-8-sig") as f:
            ...
            for idx, row in enumerate(reader):
                ...
                label = row[SciTailProcessor.LABEL_COLUMN]
                text_a = row[SciTailProcessor.TEXT_A_COLUMN]
                text_b = row[SciTailProcessor.TEXT_B_COLUMN]
...
PROCESSORS[SciTailProcessor.TASK_NAME] = SciTailProcessor
